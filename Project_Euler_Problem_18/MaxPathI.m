...
while( ii <= size( K,1) )    
    ...
    for j = size(K,2)+1:1:M - 1
        ...
        if( ( A( U( 1, 1 ), j + 1 ) >= A( U( 1, 2 ), j + 1 ) && A( U( 1, 1 ), j + 1 ) >= A( U( 1, 3 ), j + 1 ) && L( 1, j ) == I( U( 1, 1 ), j + 1 ) ) ||...
               ( A( U( 1, 1 ), j + 1 ) >= A( U( 1, 2 ), j + 1 ) && A( U( 1, 1 ), j + 1 ) >= A( U( 1, 3 ), j + 1 ) && L( 1, j ) == I( U( 1, 1 ), j + 1 ) + 1 ) )
        
            RR( 1, 1 ) = A( U( 1, 1 ), j + 1);            
            L( 1, j + 1) = I( U( 1, 1 ), j + 1);
        elseif ( ( A( U( 1, 2 ), j + 1 ) >= A( U( 1, 1 ), j + 1 ) && A( U( 1, 2 ), j + 1 ) >= A( U( 1, 3 ), j + 1 ) && L( 1, j ) == I( U( 1, 2 ), j + 1 ) ) ||...
               A( U( 1, 2 ), j + 1 ) >= A( U( 1, 1 ), j + 1 ) && A( U( 1, 2 ), j + 1 ) >= A( U( 1, 3 ), j + 1 ) && L( 1, j ) == I( U( 1, 2 ), j + 1 ) + 1 )
        
            RR( 2, 1 ) = A( U( 1, 2 ), j + 1);            
            L( 1, j + 1 ) = I( U( 1, 2 ), j + 1);
        elseif ( ( A( U( 1, 3 ), j + 1 ) >= A( U( 1, 1 ), j + 1 ) && A( U( 1, 3 ), j + 1 ) >= A( U( 1, 2 ), j + 1 ) && L( 1, j ) == I( U( 1, 3 ), j + 1 ) ) ||...
                A( U( 1, 3 ), j + 1 ) >= A( U( 1, 1 ), j + 1 ) && A( U( 1, 3 ), j + 1 ) >= A( U( 1, 2 ), j + 1 ) && L( 1, j ) == I( U( 1, 3 ), j + 1 ) )
