...
while( ii <= size( K,1) )    
    ...
    for j = size(K,2)+1:1:M - 2

        [ U( 1, 1 ), ~, ~ ] = find( I( :, j ) == L( ii, j - 1 ) );
        [ U( 1, 2 ), ~, ~ ] = find( I( :, j ) == L( ii, j - 1 ) + 1 );
        [ U( 1, 3 ), ~, ~ ] = find( I( :, j + 1 ) == L( ii, j - 1 ) + 2 );
        [ U( 1, 4 ), ~, ~ ] = find( I( :, j + 2 ) == L( ii, j - 1 ) + 3 );

        if( A( U( 1, 1 ), j ) >= A( U( 1, 2 ), j ) )   
           
            V( 1, 1 ) = A( U( 1, 1 ), j ) + A( U( 1, 1 ), j + 1 ) + A( U( 1, 1 ), j + 2 );
            V( 1, 2 ) = A( U( 1, 1 ), j ) + A( U( 1, 1 ), j + 1 ) + A( U( 1, 2 ), j + 2 );
            V( 1, 3 ) = A( U( 1, 1 ), j ) + A( U( 1, 2 ), j + 1 ) + A( U( 1, 2 ), j + 2 );
            V( 1, 4 ) = A( U( 1, 1 ), j ) + A( U( 1, 2 ), j + 1 ) + A( U( 1, 3 ), j + 2 );

            if( V( 1, 1 ) > V( 1, 2 ) && V( 1, 1 ) > V( 1, 3 ) && V( 1, 1 ) > V( 1, 4 ) )

                RR( 1, 1 ) = A( U( 1, 1 ), j );            
                L( ii, j ) = I( U( 1, 1 ), j );  

                V( 1, 1 ) = 0; V( 1, 2 ) = 0; V( 1, 3 ) = 0; V( 1, 4 ) = 0;
            elseif( V( 1, 2 ) > V( 1, 1 ) && V( 1, 2 ) > V( 1, 3 ) && V( 1, 2 ) > V( 1, 4 ) ) 

                 RR( 1, 1 ) = A( U( 1, 1 ), j );            
                 L( ii, j ) = I( U( 1, 1 ), j );  

                 V( 1, 1 ) = 0; V( 1, 2 ) = 0; V( 1, 3 ) = 0; V( 1, 4 ) = 0;
             elseif( V( 1, 3 ) > V( 1, 1 ) && V( 1, 3 ) > V( 1, 2 ) && V( 1, 3 ) > V( 1, 4 ) ) 
    
                 RR( 1, 1 ) = A( U( 1, 1 ), j );            
                 L( ii, j ) = I( U( 1, 1 ), j );  

                 V( 1, 1 ) = 0; V( 1, 2 ) = 0; V( 1, 3 ) = 0; V( 1, 4 ) = 0;
             elseif( V( 1, 4 ) > V( 1, 1 ) && V( 1, 4 ) > V( 1, 2 ) && V( 1, 4 ) > V( 1, 3 ) ) 
        ...
        elseif ( A( U( 1, 2 ), j ) >= A( U( 1, 1 ), j ) ) 
            ...
            V( 1, 1 ) = A( U( 1, 2 ), j ) + A( U( 1, 2 ), j + 1 ) + A( U( 1, 2 ), j + 2 );
            V( 1, 2 ) = A( U( 1, 2 ), j ) + A( U( 1, 2 ), j + 1 ) + A( U( 1, 3 ), j + 2 );
            V( 1, 3 ) = A( U( 1, 2 ), j ) + A( U( 1, 3 ), j + 1 ) + A( U( 1, 3 ), j + 2 );
            V( 1, 4 ) = A( U( 1, 2 ), j ) + A( U( 1, 3 ), j + 1 ) + A( U( 1, 4 ), j + 2 );
