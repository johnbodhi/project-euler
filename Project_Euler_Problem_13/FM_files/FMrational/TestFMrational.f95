...
!  This is a test program for the FM 1.3 multiple-precision rational arithmetic package.
...
!  Function that returns a rational result.
      ...
      IMPLICIT NONE
      TYPE (FM_RATIONAL) :: A,B,SUM0
      CALL FM_ENTER_USER_FUNCTION(SUM0)
      SUM0 = A + B
      CALL FM_EXIT_USER_FUNCTION(SUM0)
      END FUNCTION SUM0
...
!  Function that returns a rational vector result.
      ...
      USE FM_RATIONAL_ARITHMETIC
      IMPLICIT NONE
      TYPE (FM_RATIONAL) :: A(3),B(3),SUM1(3)
      INTEGER :: J
      CALL FM_ENTER_USER_FUNCTION(SUM1)
      DO J = 1, 3
         SUM1(J) = A(J) + B(J)
      ENDDO
      CALL FM_EXIT_USER_FUNCTION(SUM1)
      END FUNCTION SUM1
...
!  Function that returns a rational matrix result.
      ...
      USE FM_RATIONAL_ARITHMETIC
      IMPLICIT NONE
      TYPE (FM_RATIONAL) :: A(3,3),B(3,3),SUM2(3,3)
      INTEGER :: J, K
      CALL FM_ENTER_USER_FUNCTION(SUM2)
      DO J = 1, 3
         DO K = 1, 3
            SUM2(J,K) = A(J,K) + B(J,K)
         ENDDO
      ENDDO
      CALL FM_EXIT_USER_FUNCTION(SUM2)
      END FUNCTION SUM2
...
!             These are the variables that are not multiple precision.
      ...
      INTEGER, SAVE :: J, K, KLOG, L, KWSAVE, ML(2), NCASE, NERROR
...
!             and these should be treated as errors for these tests.
      ...
      IF ( (.NOT. IMCOMPARE(RESULT%NUMERATOR,'==',CORRECT%NUMERATOR)) .OR.  &
          ...
          CALL ERRPRTRM(' TO_FM_RATIONAL',0,A,'A',B,'B',B,'B')
      ENDIF
      ...
      IF ( (.NOT. IMCOMPARE(RESULT%NUMERATOR,'==',CORRECT%NUMERATOR)) .OR.  &
           (.NOT. IMCOMPARE(RESULT%DENOMINATOR,'==',CORRECT%DENOMINATOR)) ) THEN
          CALL ERRPRTRM(' = assignment',0,A,'A',B,'B',B,'B')
      ENDIF
      ...
      IF ( (.NOT. IMCOMPARE(RESULT%NUMERATOR,'==',CORRECT%NUMERATOR)) .OR.  &
           (.NOT. IMCOMPARE(RESULT%DENOMINATOR,'==',CORRECT%DENOMINATOR)) ) THEN
          CALL ERRPRTRM(' addition of rationals',0,A,'A',B,'B',B,'B')
      ENDIF
      ...
      IF ( (.NOT. IMCOMPARE(RESULT%NUMERATOR,'==',CORRECT%NUMERATOR)) .OR.  &
           (.NOT. IMCOMPARE(RESULT%DENOMINATOR,'==',CORRECT%DENOMINATOR)) ) THEN
          CALL ERRPRTRM(' subtraction of rationals',0,A,'A',B,'B',B,'B')
      ENDIF
      ...
      IF ( (.NOT. IMCOMPARE(RESULT%NUMERATOR,'==',CORRECT%NUMERATOR)) .OR.  &
           (.NOT. IMCOMPARE(RESULT%DENOMINATOR,'==',CORRECT%DENOMINATOR)) ) THEN
          CALL ERRPRTRM(' multiplication of rationals',0,A,'A',B,'B',B,'B')
      ENDIF
      ...
      IF ( (.NOT. IMCOMPARE(RESULT%NUMERATOR,'==',CORRECT%NUMERATOR)) .OR.  &
           (.NOT. IMCOMPARE(RESULT%DENOMINATOR,'==',CORRECT%DENOMINATOR)) ) THEN
          CALL ERRPRTRM(' division of rationals',0,A,'A',B,'B',B,'B')
      ENDIF
      ...
      DO J = 1, 3
         ...
         IF ( (.NOT. IMCOMPARE(CVEC(J)%NUMERATOR,'==',DVEC(J)%NUMERATOR)) .OR.  &
             ...
             CALL ERRPRTRM(' array operations -- addition of rationals',0,A,'A',B,'B',B,'B')
         ENDIF
      ENDDO
      KW = KWSAVE
      ...
      DO J = 1, 3
         ...
         IF ( (.NOT. IMCOMPARE(CVEC(J)%NUMERATOR,'==',DVEC(J)%NUMERATOR)) .OR.  &
              (.NOT. IMCOMPARE(CVEC(J)%DENOMINATOR,'==',DVEC(J)%DENOMINATOR)) ) THEN
             CALL ERRPRTRM(' array operations -- subtraction of rationals',0,A,'A',B,'B',B,'B')
         ENDIF
      ENDDO
      KW = KWSAVE
      ...
      DO J = 1, 3
         ...
         IF ( (.NOT. IMCOMPARE(CVEC(J)%NUMERATOR,'==',DVEC(J)%NUMERATOR)) .OR.  &
              (.NOT. IMCOMPARE(CVEC(J)%DENOMINATOR,'==',DVEC(J)%DENOMINATOR)) ) THEN
             CALL ERRPRTRM(' array operations -- multiplication of rationals',0,A,'A',B,'B',B,'B')
         ENDIF
      ENDDO
      KW = KWSAVE
      ...
      DO J = 1, 3
         ...
         IF ( (.NOT. IMCOMPARE(CVEC(J)%NUMERATOR,'==',DVEC(J)%NUMERATOR)) .OR.  &
              (.NOT. IMCOMPARE(CVEC(J)%DENOMINATOR,'==',DVEC(J)%DENOMINATOR)) ) THEN
             CALL ERRPRTRM(' array operations -- division of rationals',0,A,'A',B,'B',B,'B')
         ENDIF
      ENDDO
      KW = KWSAVE
      ...
      B = A
      IF ( .NOT.( A == B ) ) THEN
          CALL ERRPRTRM(' == comparison of rationals',-1,A,'A',B,'B',B,'B')
      ENDIF
      ...
      IF ( (.NOT. IMCOMPARE(RESULT%NUMERATOR,'==',CORRECT%NUMERATOR)) .OR.  &
           (.NOT. IMCOMPARE(RESULT%DENOMINATOR,'==',CORRECT%DENOMINATOR)) ) THEN
          CALL ERRPRTRM(' ABS',0,A,'A',B,'B',B,'B')
      ENDIF
      ...
      DO J = 1, 3
         ...
         IF ( (.NOT. IMCOMPARE(BVEC(J)%NUMERATOR,'==',CORRECT%NUMERATOR)) .OR.  &
             ...
             CALL ERRPRTRM(' array arguments -- ABS',0,A,'A',B,'B',B,'B')
         ENDIF
      ENDDO
      ...
      IF ( (.NOT. IMCOMPARE(RESULT%NUMERATOR,'==',CORRECT%NUMERATOR)) .OR.  &
           (.NOT. IMCOMPARE(RESULT%DENOMINATOR,'==',CORRECT%DENOMINATOR)) ) THEN
          CALL ERRPRTRM(' CEILING',0,A,'A',B,'B',B,'B')
      ENDIF
      ...
      DO J = 1, 3
         ...
         IF ( (.NOT. IMCOMPARE(BVEC(J)%NUMERATOR,'==',CORRECT%NUMERATOR)) .OR.  &
              (.NOT. IMCOMPARE(BVEC(J)%DENOMINATOR,'==',CORRECT%DENOMINATOR)) ) THEN
             CALL ERRPRTRM(' array arguments -- CEILING',0,A,'A',B,'B',B,'B')
         ENDIF
      ENDDO
      ...
      IF ( (.NOT. IMCOMPARE(RESULT%NUMERATOR,'==',CORRECT%NUMERATOR)) .OR.  &
           (.NOT. IMCOMPARE(RESULT%DENOMINATOR,'==',CORRECT%DENOMINATOR)) ) THEN
          CALL ERRPRTRM(' DIM',0,A,'A',B,'B',B,'B')
      ENDIF
      ...
      DO J = 1, 3
         ...
         IF ( (.NOT. IMCOMPARE(CVEC(J)%NUMERATOR,'==',CORRECT%NUMERATOR)) .OR.  &
             ...
             CALL ERRPRTRM(' array arguments -- DIM',0,A,'A',B,'B',B,'B')
         ENDIF
      ENDDO
      ...
      IF ( (.NOT. IMCOMPARE(RESULT%NUMERATOR,'==',CORRECT%NUMERATOR)) .OR.  &
           (.NOT. IMCOMPARE(RESULT%DENOMINATOR,'==',CORRECT%DENOMINATOR)) ) THEN
          CALL ERRPRTRM(' FLOOR',0,A,'A',B,'B',B,'B')
      ENDIF
      ...
      DO J = 1, 3
         ...
         IF ( (.NOT. IMCOMPARE(BVEC(J)%NUMERATOR,'==',CORRECT%NUMERATOR)) .OR.  &
              (.NOT. IMCOMPARE(BVEC(J)%DENOMINATOR,'==',CORRECT%DENOMINATOR)) ) THEN
             CALL ERRPRTRM(' array arguments -- FLOOR',0,A,'A',B,'B',B,'B')
         ENDIF
      ENDDO
      ...
      IF ( (.NOT. IMCOMPARE(RESULT%NUMERATOR,'==',CORRECT%NUMERATOR)) .OR.  &
           (.NOT. IMCOMPARE(RESULT%DENOMINATOR,'==',CORRECT%DENOMINATOR)) ) THEN
          CALL ERRPRTRM(' INT',0,A,'A',B,'B',B,'B')
      ENDIF
      ...
      DO J = 1, 3
         ...
         IF ( (.NOT. IMCOMPARE(BVEC(J)%NUMERATOR,'==',CORRECT%NUMERATOR)) .OR.  &
              (.NOT. IMCOMPARE(BVEC(J)%DENOMINATOR,'==',CORRECT%DENOMINATOR)) ) THEN
             CALL ERRPRTRM(' array arguments -- INT',0,A,'A',B,'B',B,'B')
         ENDIF
      ENDDO
      ...
      IF ( (.NOT. IMCOMPARE(RESULT%NUMERATOR,'==',CORRECT%NUMERATOR)) .OR.  &
           (.NOT. IMCOMPARE(RESULT%DENOMINATOR,'==',CORRECT%DENOMINATOR)) ) THEN
          CALL ERRPRTRM(' MOD',0,A,'A',B,'B',B,'B')
      ENDIF
      ...
      DO J = 1, 3
         ...
         IF ( (.NOT. IMCOMPARE(CVEC(J)%NUMERATOR,'==',CORRECT%NUMERATOR)) .OR.  &
              (.NOT. IMCOMPARE(CVEC(J)%DENOMINATOR,'==',CORRECT%DENOMINATOR)) ) THEN
             CALL ERRPRTRM(' array arguments -- MOD',0,A,'A',B,'B',B,'B')
         ENDIF
      ENDDO
      ...
      IF ( (.NOT. IMCOMPARE(RESULT%NUMERATOR,'==',CORRECT%NUMERATOR)) .OR.  &
           (.NOT. IMCOMPARE(RESULT%DENOMINATOR,'==',CORRECT%DENOMINATOR)) ) THEN
          CALL ERRPRTRM(' MODULO',0,A,'A',B,'B',B,'B')
      ENDIF
      ...
      DO J = 1, 3
         ...
         IF ( (.NOT. IMCOMPARE(CVEC(J)%NUMERATOR,'==',CORRECT%NUMERATOR)) .OR.  &
              (.NOT. IMCOMPARE(CVEC(J)%DENOMINATOR,'==',CORRECT%DENOMINATOR)) ) THEN
             CALL ERRPRTRM(' array arguments -- MODULO',0,A,'A',B,'B',B,'B')
         ENDIF
      ENDDO
      ...
      IF ( (.NOT. IMCOMPARE(RESULT%NUMERATOR,'==',CORRECT%NUMERATOR)) .OR.  &
           (.NOT. IMCOMPARE(RESULT%DENOMINATOR,'==',CORRECT%DENOMINATOR)) ) THEN
          CALL ERRPRTRM(' NINT',0,A,'A',B,'B',B,'B')
      ENDIF
      ...
      DO J = 1, 3
         ...
         IF ( (.NOT. IMCOMPARE(BVEC(J)%NUMERATOR,'==',CORRECT%NUMERATOR)) .OR.  &
              (.NOT. IMCOMPARE(BVEC(J)%DENOMINATOR,'==',CORRECT%DENOMINATOR)) ) THEN
             CALL ERRPRTRM(' array arguments -- NINT',0,A,'A',B,'B',B,'B')
         ENDIF
      ENDDO
      ...
      DO J = 1, 3
         ...
         IF ( (.NOT. IMCOMPARE(BVEC(J)%NUMERATOR,'==',CORRECT%NUMERATOR)) .OR.  &
              (.NOT. IMCOMPARE(BVEC(J)%DENOMINATOR,'==',CORRECT%DENOMINATOR)) ) THEN
             CALL ERRPRTRM(' array arguments -- **',0,A,'A',B,'B',B,'B')
         ENDIF
      ENDDO
      ...
      IF ( .NOT.( MFM1 == MFM2 ) ) THEN
          CALL ERRPRTRM(' TO_FM',-1,A,'A',B,'B',B,'B')
      ENDIF
      ...
      DO J = 1, 3
         ...
         IF ( .NOT.( MFMVEC(J) == MFM2 ) ) THEN
             CALL ERRPRTRM(' array arguments -- TO_FM',0,A,'A',B,'B',B,'B')
         ENDIF
      ENDDO
      ...
      IF ( (.NOT. IMCOMPARE(RESULT%NUMERATOR,'==',CORRECT%NUMERATOR)) .OR.  &
           (.NOT. IMCOMPARE(RESULT%DENOMINATOR,'==',CORRECT%DENOMINATOR)) ) THEN
          CALL ERRPRTRM(' RATIONAL_APPROX',0,A,'A',B,'B',B,'B')
      ENDIF
      ...
      IF ( (.NOT. IMCOMPARE(RESULT%NUMERATOR,'==',CORRECT%NUMERATOR)) .OR.  &
           (.NOT. IMCOMPARE(RESULT%DENOMINATOR,'==',CORRECT%DENOMINATOR)) ) THEN
          CALL ERRPRTRM(' MAX',0,A,'A',B,'B',B,'B')
      ENDIF
      ...
      IF ( (.NOT. IMCOMPARE(RESULT%NUMERATOR,'==',CORRECT%NUMERATOR)) .OR.  &
           (.NOT. IMCOMPARE(RESULT%DENOMINATOR,'==',CORRECT%DENOMINATOR)) ) THEN
          CALL ERRPRTRM(' MIN',0,A,'A',B,'B',B,'B')
      ENDIF
      ...
      IF ( IS_UNKNOWN( TO_FM_RATIONAL(-7,9) ) ) THEN
          CALL ERRPRTRM(' IS_UNKNOWN',0,A,'A',B,'B',B,'B')
      ENDIF
      ...
      IF ( (.NOT. IMCOMPARE(RESULT%NUMERATOR,'==',CORRECT%NUMERATOR)) .OR.  &
           (.NOT. IMCOMPARE(RESULT%DENOMINATOR,'==',CORRECT%DENOMINATOR)) ) THEN
          CALL ERRPRTRM(' DOT_PRODUCT',0,A,'A',B,'B',B,'B')
      ENDIF
      ...
      DO J = 1, 3
         DO K = 1, 3
            ...
            IF ( (.NOT. IMCOMPARE(CMAT(J,K)%NUMERATOR,'==',DMAT(J,K)%NUMERATOR)) .OR.  &
                 (.NOT. IMCOMPARE(CMAT(J,K)%DENOMINATOR,'==',DMAT(J,K)%DENOMINATOR)) ) THEN
                CALL ERRPRTRM(' array arguments -- MATMUL',0,A,'A',B,'B',B,'B')
            ENDIF
         ENDDO
      ENDDO
      KW = KWSAVE
      ...
      K = 2
      IF (J /= K) THEN
          CALL ERRPRTRM(' array arguments -- MAXLOC',0,A,'A',B,'B',B,'B')
      ENDIF
      ...
      IF ( (.NOT. IMCOMPARE(RESULT%NUMERATOR,'==',CORRECT%NUMERATOR)) .OR.  &
           (.NOT. IMCOMPARE(RESULT%DENOMINATOR,'==',CORRECT%DENOMINATOR)) ) THEN
          CALL ERRPRTRM(' array arguments -- MAXVAL',0,A,'A',B,'B',B,'B')
      ENDIF
      ...
      K = 3
      IF (J /= K) THEN
          CALL ERRPRTRM(' array arguments -- MINLOC',0,A,'A',B,'B',B,'B')
      ENDIF
      ...
      IF ( (.NOT. IMCOMPARE(RESULT%NUMERATOR,'==',CORRECT%NUMERATOR)) .OR.  &
           (.NOT. IMCOMPARE(RESULT%DENOMINATOR,'==',CORRECT%DENOMINATOR)) ) THEN
          CALL ERRPRTRM(' array arguments -- MINVAL',0,A,'A',B,'B',B,'B')
      ENDIF
      ...
      IF ( (.NOT. IMCOMPARE(RESULT%NUMERATOR,'==',CORRECT%NUMERATOR)) .OR.  &
           (.NOT. IMCOMPARE(RESULT%DENOMINATOR,'==',CORRECT%DENOMINATOR)) ) THEN
          CALL ERRPRTRM(' array arguments -- PRODUCT',0,A,'A',B,'B',B,'B')
      ENDIF
      ...
      IF ( (.NOT. IMCOMPARE(RESULT%NUMERATOR,'==',CORRECT%NUMERATOR)) .OR.  &
           (.NOT. IMCOMPARE(RESULT%DENOMINATOR,'==',CORRECT%DENOMINATOR)) ) THEN
          CALL ERRPRTRM(' array arguments -- SUM',0,A,'A',B,'B',B,'B')
      ENDIF
      ...
      DO J = 1, 3
         DO K = 1, 3
            ...
            IF ( (.NOT. IMCOMPARE(CMAT(J,K)%NUMERATOR,'==',DMAT(J,K)%NUMERATOR)) .OR.  &
                 (.NOT. IMCOMPARE(CMAT(J,K)%DENOMINATOR,'==',DMAT(J,K)%DENOMINATOR)) ) THEN
                CALL ERRPRTRM(' array arguments -- TRANSPOSE',0,A,'A',B,'B',B,'B')
            ENDIF
         ENDDO
      ENDDO
      KW = KWSAVE
      ...
      DO J = 1, 3
         ...
         IF ( (.NOT. IMCOMPARE(CVEC(J)%NUMERATOR,'==',DVEC(J)%NUMERATOR)) .OR.  &
              (.NOT. IMCOMPARE(CVEC(J)%DENOMINATOR,'==',DVEC(J)%DENOMINATOR)) ) THEN
             CALL ERRPRTRM(' array arguments -- RM_LIN_SOLVE',0,A,'A',B,'B',B,'B')
         ENDIF
      ENDDO
      WRITE (KLOG,"(A)") ' det D ='
      CALL FM_PRINT_RATIONAL(D)
      IF (.NOT. D == TO_FM_RATIONAL(-8,125)) THEN
          CALL ERRPRTRM(' array arguments -- RM_LIN_SOLVE det',0,A,'A',B,'B',B,'B')
      ENDIF
      KW = KWSAVE
      ...
      DO J = 1, 3
         ...
         IF ( (.NOT. IMCOMPARE(CVEC(J)%NUMERATOR,'==',DVEC(J)%NUMERATOR)) .OR.  &
              (.NOT. IMCOMPARE(CVEC(J)%DENOMINATOR,'==',DVEC(J)%DENOMINATOR)) ) THEN
             CALL ERRPRTRM(' array arguments -- RM_LIN_SOLVE2',0,A,'A',B,'B',B,'B')
         ENDIF
      ENDDO
      WRITE (KLOG,"(A)") ' det D ='
      CALL FM_PRINT_RATIONAL(D)
      IF (.NOT. D == TO_FM_RATIONAL(-8,125)) THEN
          CALL ERRPRTRM(' array arguments -- RM_LIN_SOLVE2 det',0,A,'A',B,'B',B,'B')
      ENDIF
      KW = KWSAVE
      ...
      DO J = 1, 3
         DO K = 1, 3
            ...
            IF ( (.NOT. IMCOMPARE(BMAT(J,K)%NUMERATOR,'==',DMAT(J,K)%NUMERATOR)) .OR.  &
                 (.NOT. IMCOMPARE(BMAT(J,K)%DENOMINATOR,'==',DMAT(J,K)%DENOMINATOR)) ) THEN
                CALL ERRPRTRM(' array arguments -- RM_INVERSE',0,A,'A',B,'B',B,'B')
            ENDIF
         ENDDO
      ENDDO
      WRITE (KLOG,"(A)") ' det D ='
      CALL FM_PRINT_RATIONAL(D)
      IF (.NOT. D == TO_FM_RATIONAL(-8,125)) THEN
          CALL ERRPRTRM(' array arguments -- RM_INVERSE det',0,A,'A',B,'B',B,'B')
      ENDIF
      KW = KWSAVE
      ...
      DO J = 1, 3
         DO K = 1, 3
            ...
            IF ( (.NOT. IMCOMPARE(BMAT(J,K)%NUMERATOR,'==',DMAT(J,K)%NUMERATOR)) .OR.  &
                 (.NOT. IMCOMPARE(BMAT(J,K)%DENOMINATOR,'==',DMAT(J,K)%DENOMINATOR)) ) THEN
                CALL ERRPRTRM(' array arguments -- RM_INVERSE2',0,A,'A',B,'B',B,'B')
            ENDIF
         ENDDO
      ENDDO
      WRITE (KLOG,"(A)") ' det D ='
      CALL FM_PRINT_RATIONAL(D)
      IF (.NOT. D == TO_FM_RATIONAL(-8,125)) THEN
          CALL ERRPRTRM(' array arguments -- RM_INVERSE2 det',0,A,'A',B,'B',B,'B')
      ENDIF
      KW = KWSAVE
      ...
      IF ( (.NOT. IMCOMPARE(C%NUMERATOR,'==',D%NUMERATOR)) .OR.  &
           ...
           CALL ERRPRTRM(' rational-valued function call',0,A,'A',B,'B',B,'B')
      ENDIF
      KW = KWSAVE
      ...
      DO J = 1, 3
         IF ( (.NOT. IMCOMPARE(CVEC(J)%NUMERATOR,'==',DVEC(J)%NUMERATOR)) .OR.  &
              (.NOT. IMCOMPARE(CVEC(J)%DENOMINATOR,'==',DVEC(J)%DENOMINATOR)) ) THEN
              CALL ERRPRTRM(' rational-valued vector function call',0,A,'A',B,'B',B,'B')
         ENDIF
      ENDDO
      ...
      SUBROUTINE ERRPRTRM(OPERATION,NARGS,M1,NAME1,M2,NAME2,M3,NAME3)

!  Print error messages.

!  OPERATION is the operation being tested.
!  NARGS is the number of input arguments.  (not used in this version)
!  M1, M2, M3, are the values of the input arguments.  (not used in this version)
!  NAME1, 2, 3 are the variable names of the input arguments.  (not used in this version)

      USE FM_RATIONAL_ARITHMETIC
      IMPLICIT NONE

      TYPE (FM_RATIONAL) :: M1,M2,M3
